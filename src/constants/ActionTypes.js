...
export const SHOW_SECTION_FOUR_DATA = 'show_section_four-data';
export const DELETE_SECTION_FOUR_DATA = 'delete_section_four-data';
export const SHOW_SECTION_FIVE_DATA = 'show_section_five-data';
